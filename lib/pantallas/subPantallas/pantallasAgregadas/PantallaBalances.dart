                  ...
                  children: [
                    ...
                    StreamBuilder<QuerySnapshot>(
                      stream:
                          unidadRef
                              .collection("Bizums")
                              .where("hecho", isEqualTo: true)
                              .snapshots(),
                      builder: (context, snapshotBizumsHechos) {
                        if (snapshotBizumsHechos.connectionState ==
                        ...
                        final bizumsHechos =
                            snapshotBizumsHechos.data?.docs ?? [];

                        if (bizumsHechos.isEmpty) {
                          return const Text("No hay Bizums realizados aún.");
                        }
                        final ordenados = List.from(bizumsHechos)..sort((a, b) {
                        ...
                        return Column(
                          children:
                              ordenados.map((bizumDoc) {
                                final data =
                                    bizumDoc.data() as Map<String, dynamic>;
                                return FutureBuilder<List<String>>(
                                  future: obtenerNombresUsuarios(
                                    data["personaPaga"] as DocumentReference,
                                    data["personaRecibe"] as DocumentReference,
